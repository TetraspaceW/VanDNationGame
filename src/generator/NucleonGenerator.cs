...
class NucleonGenerator
{
    ...
    {
        this.parent = tile;
        this.quarks = new List<Terrain.QuarkFlavour> { q1, q2, q3 };
    }
    ...
    public TileModel[,] GenerateNucleon()
    {
        ...
        new List<Terrain.QuarkColour> { Terrain.QuarkColour.Red, Terrain.QuarkColour.Green, Terrain.QuarkColour.Blue }
        .OrderBy(a => RND.Next())
